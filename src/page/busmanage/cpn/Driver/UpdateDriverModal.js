...
const UpdateDriverModal = ({ show, onHide, driver, onUpdate }) => {
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                setUpdatedDriver({ ...updatedDriver, driver_ava: reader.result, driver_avaUrl: '' });
    ...
    const handleUrlChange = (e) => {
        const { name, value } = e.target;
        setUpdatedDriver({ ...updatedDriver, [name]: value, driver_ava: '' });
                ...
                <Form>
                    ...
                    <Form.Group controlId="formDriverAva">
                        ...
                        <Form.Control
                            ...
                            name="driver_avaUrl"
                            value={updatedDriver.driver_avaUrl || ''}
